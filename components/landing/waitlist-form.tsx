...
export function WaitlistForm() {
  ...
  return (
    <section id="waitlist" className="border-t border-border bg-neutral-50 py-24 sm:py-32">
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          <FadeIn>
            ...
            <p className="mt-6 max-w-md text-muted-foreground">
              We&apos;re launching in {LAUNCH_CITY} with a curated member base.
              Join the waitlist — women receive free lifetime access, men can
              secure founding membership before we open.
            </p>
          </FadeIn>
